  ...
  return (
    ...
    >
      <div className="relative h-full w-full">
        {current ? (
          <>
            <div className="absolute -top-6 left-1/2 z-10 -translate-x-1/2 animate-bounce rounded-xl border-2 bg-white px-3 py-2.5 font-bold uppercase tracking-wide text-brand-500">
              Start
              <div
